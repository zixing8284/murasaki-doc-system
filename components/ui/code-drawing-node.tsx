  ...
  return (
    ...
    >
      {!readOnly && (
        ...
        >
          <SelectTrigger
            className={`h-8 w-30 border-0 bg-muted/50 text-xs shadow-none ${isMobile ? '' : 'transition-colors hover:bg-zinc-200'
              }`}
          >
            <SelectValue />
          </SelectTrigger>
      ...
      {!readOnly && (
        ...
        >
          <SelectTrigger
            className={`h-8 w-20 border-0 bg-muted/50 text-xs shadow-none ${isMobile ? '' : 'transition-colors hover:bg-zinc-200'
              }`}
          >
            <SelectValue />
          </SelectTrigger>
